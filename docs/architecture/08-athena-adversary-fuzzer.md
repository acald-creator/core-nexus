...
| Phase 3: High-assurance target | Headless adversary fuzzer inside `kiln` | Continuously test designated sandbox workloads and feed signed ground-truth data into the AI-SOC loop. |
